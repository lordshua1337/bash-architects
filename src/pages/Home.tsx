    ...
    <div style={{
      ...
      <div style={{
        ...
        background: `conic-gradient(
          from 0deg,
          transparent 0deg, #C9978A 1.5deg, transparent 3deg,
          transparent 5deg, #C9978A 6.5deg, transparent 8deg,
          transparent 10deg, #C9978A 11.5deg, transparent 13deg,
          transparent 15deg, #C9978A 16.5deg, transparent 18deg,
          transparent 20deg, #C9978A 21.5deg, transparent 23deg,
          transparent 25deg, #C9978A 26.5deg, transparent 28deg,
          transparent 30deg, #C9978A 31.5deg, transparent 33deg,
          transparent 35deg, #C9978A 36.5deg, transparent 38deg,
          transparent 40deg, #C9978A 41.5deg, transparent 43deg,
          transparent 45deg, #C9978A 46.5deg, transparent 48deg,
          transparent 50deg, #C9978A 51.5deg, transparent 53deg,
          transparent 55deg, #C9978A 56.5deg, transparent 58deg,
          transparent 60deg, #C9978A 61.5deg, transparent 63deg,
          transparent 65deg, #C9978A 66.5deg, transparent 68deg,
          transparent 70deg, #C9978A 71.5deg, transparent 73deg,
          transparent 75deg, #C9978A 76.5deg, transparent 78deg,
          transparent 80deg, #C9978A 81.5deg, transparent 83deg,
          transparent 85deg, #C9978A 86.5deg, transparent 88deg,
          transparent 90deg, #C9978A 91.5deg, transparent 93deg,
          transparent 95deg, #C9978A 96.5deg, transparent 98deg,
          transparent 100deg, #C9978A 101.5deg, transparent 103deg,
          transparent 105deg, #C9978A 106.5deg, transparent 108deg,
          transparent 110deg, #C9978A 111.5deg, transparent 113deg,
          transparent 115deg, #C9978A 116.5deg, transparent 118deg,
          transparent 120deg, #C9978A 121.5deg, transparent 123deg,
          transparent 125deg, #C9978A 126.5deg, transparent 128deg,
          transparent 130deg, #C9978A 131.5deg, transparent 133deg,
          transparent 135deg, #C9978A 136.5deg, transparent 138deg,
          transparent 140deg, #C9978A 141.5deg, transparent 143deg,
          transparent 145deg, #C9978A 146.5deg, transparent 148deg,
          transparent 150deg, #C9978A 151.5deg, transparent 153deg,
          transparent 155deg, #C9978A 156.5deg, transparent 158deg,
          transparent 160deg, #C9978A 161.5deg, transparent 163deg,
          transparent 165deg, #C9978A 166.5deg, transparent 168deg,
          transparent 170deg, #C9978A 171.5deg, transparent 173deg,
          transparent 175deg, #C9978A 176.5deg, transparent 178deg,
          transparent 180deg, #C9978A 181.5deg, transparent 183deg,
          transparent 185deg, #C9978A 186.5deg, transparent 188deg,
          transparent 190deg, #C9978A 191.5deg, transparent 193deg,
          transparent 195deg, #C9978A 196.5deg, transparent 198deg,
          transparent 200deg, #C9978A 201.5deg, transparent 203deg,
          transparent 205deg, #C9978A 206.5deg, transparent 208deg,
          transparent 210deg, #C9978A 211.5deg, transparent 213deg,
          transparent 215deg, #C9978A 216.5deg, transparent 218deg,
          transparent 220deg, #C9978A 221.5deg, transparent 223deg,
          transparent 225deg, #C9978A 226.5deg, transparent 228deg,
          transparent 230deg, #C9978A 231.5deg, transparent 233deg,
          transparent 235deg, #C9978A 236.5deg, transparent 238deg,
          transparent 240deg, #C9978A 241.5deg, transparent 243deg,
          transparent 245deg, #C9978A 246.5deg, transparent 248deg,
          transparent 250deg, #C9978A 251.5deg, transparent 253deg,
          transparent 255deg, #C9978A 256.5deg, transparent 258deg,
          transparent 260deg, #C9978A 261.5deg, transparent 263deg,
          transparent 265deg, #C9978A 266.5deg, transparent 268deg,
          transparent 270deg, #C9978A 271.5deg, transparent 273deg,
          transparent 275deg, #C9978A 276.5deg, transparent 278deg,
          transparent 280deg, #C9978A 281.5deg, transparent 283deg,
          transparent 285deg, #C9978A 286.5deg, transparent 288deg,
          transparent 290deg, #C9978A 291.5deg, transparent 293deg,
          transparent 295deg, #C9978A 296.5deg, transparent 298deg,
          transparent 300deg, #C9978A 301.5deg, transparent 303deg,
          transparent 305deg, #C9978A 306.5deg, transparent 308deg,
          transparent 310deg, #C9978A 311.5deg, transparent 313deg,
          transparent 315deg, #C9978A 316.5deg, transparent 318deg,
          transparent 320deg, #C9978A 321.5deg, transparent 323deg,
          transparent 325deg, #C9978A 326.5deg, transparent 328deg,
          transparent 330deg, #C9978A 331.5deg, transparent 333deg,
          transparent 335deg, #C9978A 336.5deg, transparent 338deg,
          transparent 340deg, #C9978A 341.5deg, transparent 343deg,
          transparent 345deg, #C9978A 346.5deg, transparent 348deg,
          transparent 350deg, #C9978A 351.5deg, transparent 353deg,
          transparent 355deg, #C9978A 356.5deg, transparent 358deg,
          transparent 360deg
        )`,
        opacity: 0.35,
        borderRadius: '50%',
